...
_flag_map = {
    ...
    "SEQUENCE PROCESSOR DATA OVERFLOW": ERROR,
    "SEQUENCE PROCESSOR EVENT OVERFLOW": ERROR,
    "SYNCHRONOUS MESSAGE FEEDBACK DATA WITHOUT HEADER": ERROR,
    "SYNCHRONOUS MESSAGE FEEDBACK PACKET NOT COMPLETED": ERROR,
    "SYNCHRONOUS MESSAGE FEEDBACK TRANSMIT OVERFLOW": ERROR,
    }
